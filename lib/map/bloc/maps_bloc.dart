...
import 'package:covid_100kmfr/model/location_model.dart';
import 'package:covid_100kmfr/model/radius_model.dart';
  ...
  Stream<MapsState> _mapGenerateMarkerToCompareToMap(
    ...
    try {
      ...
      if (_radius >= gcd.haversineDistance()) {
        message =
            'La localisation se trouve à ${gcd.haversineDistance().toInt()/1000} km';
      ...
      final _marker = Marker(
        ...
        infoWindow: InfoWindow(
          title: '${gcd.haversineDistance().toInt()/1000} km du lieu de résidence',
        ),
